...
import kotlinx.android.synthetic.main.activity_cart_list.btn_back
import kotlinx.android.synthetic.main.activity_product.*

class CartListActivity : BasicActivity() {
    ...
    fun successCartItemsList(cartList: ArrayList<Cart>) {
        ...
        if (mCartListItems.size > 0) {
            ...
            val cartList = CartListItem(this@CartListActivity, mCartListItems, true)

            rv_cart_items_list.adapter = cartList
