...
class CheckoutActivity : BasicActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_payment_method.setOnClickListener {
            placeAnOrder()
        }
        getProductList()
    }
    ...
    fun successCartItemsList(cartList: ArrayList<Cart>) {
        ...
        val cartList = CartListItem(this@CheckoutActivity, mCartItemsList, false)
        rv_cart_list_items.adapter = cartList
    ...
    private fun placeAnOrder() {
        ...
        mOrderDetails = Order(
            ...
            mCartItemsList,
            mAddressDetails!!,
            "Ma commande ${System.currentTimeMillis()}",
    ...
    fun allDetailsUpdatedSuccessfully() {
        ...
        val intent = Intent(this@CheckoutActivity, CashActivity::class.java)
